## Ishtaran Java SDK -- first public release

This is the first public **Development Preview** release of the official Ishtaran Java SDK. It is
not GA, not stable, and not production-ready -- see [Project status](../README.md#project-status)
in the README for the current, up-to-date state.
